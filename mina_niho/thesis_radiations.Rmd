...
author: "Student:Jovani Ntabgoba"
date: "August 5, 2016"
Supervisor: "Supervisor Prof Atsushi Togashi"
Supervisora: "Assistant Supervisor Prof Suguri Hiroki"
output: pdf_document
fig_width: 4
fig_height: 3
---
...
**From Linear Model**  
$$Y{i} = \beta_{0} + \beta_{1} X_{1i} + \beta_{2} X_{2i} + \beta_{3} X_{1i} X_{2i} + \epsilon_{i}$$
<br>
**Hypothesis**
...
<ol>
  ...
  <li> Effect of Air Dose Rate reduction due to the Time series nature of radiations' half life is <b>assumed constant as measured by MEXT</b>.</li>
 </ol>
<br>
...
<ol>
  ...
  <li>To contribute to the establishment of **radioactive substances distribution prediction model**.</li>
...
fukulink <- paste(sep = "<br/>",
                  "<br><a href='http://www.tepco.co.jp/en/decommision/index-e.html'>Fukushima Daichi</a></b>","Source of radiations")
```
<br>
...
```
<br>
```{r,echo=FALSE, out.width = '400pt', out.height= '400pt',fig.retina = NULL}
knitr::include_graphics("niho2011.png")
```
<br>
...
<br>
```{r,echo=FALSE, out.width = '400pt', out.height= '400pt',fig.retina = NULL}
knitr::include_graphics("niho2013.png")
```
<br>
...
<br>
```{r,echo=FALSE, out.width = '400pt', out.height= '400pt',fig.retina = NULL}
knitr::include_graphics("mina2011.png")
```
<br>
...
##### 2.1 Merging 2011 and 2013 Nihomatsu Data Sets
```{r, warning = FALSE, message = FALSE}
library(ggplot2)
...
plot(x=niho11_13$AvgAirDoseRate2011,type="l",col="red",ylab = "Avg Air Dose Rate",xlab = "Frequency of measuring",main = "Compare AvgAirDoseRate of 2011&2013 Nihomatsu")
...
#### 3.2 Developing a Linear Model

##### 3.22 Air Dose Rate Reduction due to Population Density 

**Challenge**
<p> The Air Dose Rate measurements were collected from three sources: </p>
<ul>
  <li><b>Cars and Buses with Sensors</b>: Measure Air of 100sq meters from the road</li>
  <li><b>Un manned Auto Helicopter</b>: Measure from 300m above ground</li>
  <li><b>Fixed Sensors</b>: Geographically sparsed</li>
</ul>

<br>

##### 3.23 Air Dose Rate Reduction due to Human Activities 

**Challenge**
<p> What constitutes Human Activities?: </p>
<ul>
  <li><b>Farming</b>: Short life span crops lead to frequent land tilling  </li>
  <li><b>Cleaned Places</b>: Parks, GolfCourses, Gardens are cleaned too and could reduce radiations</li>
</ul>
