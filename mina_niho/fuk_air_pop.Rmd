...
```{}
plot(fuk2013$AvgAirDoseRate,fuk_ll$totalpop)
length(fuk2013$AvgAirDoseRate)
length(fuk_ll$totalpop)
airdos <- sample(fuk2013$AvgAirDoseRate,10831)
plot(airdos,fuk_ll$totalpop)
hist(fuk_ll)
#remove slashes
fuk_air_grid2013 <- gsub("_","",fuk2013$gridcode)
...
#### 2.40 Looking at airdose rate versus land use
