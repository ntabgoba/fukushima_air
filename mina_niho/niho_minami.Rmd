...
**Linear Model**  $$Y{i} = \beta_{0} + \beta_{1} X_{1i} + \beta_{2} X_{2i} + \beta_{3} X_{1i} X_{2i} + \epsilon_{i}$$
<br>
**Mr Sato Tetsuro's Hypothesis**
...
##### 3.21 Air Dose Rate Reduction due to Distance to Daichi Plant
```{r, warning = FALSE, message = FALSE}
